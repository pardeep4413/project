    ...
    <>
      ...
      <Grid item>
        <Button
          ...
          className={classes.inputBox}
        >
          Add another institution detail
        </Button>
      </Grid>
    </>
  );
    ...
    <Paper elevation={3} className={classes.body}>
      <Grid container direction="column" spacing={4} alignItems="center">
        ...
        <Grid item>
          ...
          >
            <MenuItem value="applicant">Bike Buyer</MenuItem>
            <MenuItem value="recruiter">Bike Seller</MenuItem>
          </TextField>
        </Grid>
        <Grid item>
          <TextField
        ...
        {signupDetails.type === "applicant" ? (
          <>
            ...
            <Grid item>
              <FileUploadInput
                className={classes.inputBox}
                label="Registration certification (.pdf)"
